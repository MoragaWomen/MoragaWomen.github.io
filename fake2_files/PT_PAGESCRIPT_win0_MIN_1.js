...
function getPgltTopY(obj) 
{
 ...
 var topY = ptCommonObj2.getScrollY(); var topX = ptCommonObj2.getScrollX(); if (window.ptalPageletArea || (parent && parent.ptalPageletArea))
...
if (keyChar == "\r" && !(isButton(target) || isRowAct(target)) || key == 27)
 {
